...
class XdmfHDF(XdmfHeavyData):
    ...
    def Open(self, DataSetName = None, Access = None): return _Xdmf.XdmfHDF_Open(self, DataSetName, Access)
    def Read(self, Array = None): return _Xdmf.XdmfHDF_Read(self, Array)
    def Write(self, *args): return _Xdmf.XdmfHDF_Write(self, *args)
    def Close(self): return _Xdmf.XdmfHDF_Close(self)
