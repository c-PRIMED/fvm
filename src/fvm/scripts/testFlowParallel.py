...
contSolver.relativeTolerance = 1e-5
contSolver.nMaxIterations = 2000
contSolver.verbosity=0
if MPI.COMM_WORLD.Get_rank() == 0:
   contSolver.verbosity = 3
contSolver.maxCoarseLevels=30
