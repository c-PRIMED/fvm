...
nprocs_solid =1  
print "before spawn"
solid_comm = parent.Spawn(command="/home/yildirim/memosa/src/fvm/scripts/Structure_cantilever2D.py",   
...
nprocs_fluid = 1 
fluid_comm = parent.Spawn(command="/home/yildirim/memosa/src/fvm/scripts/Fluid_cantilever2D.py", 
