...
timeStep = 1e9 # large timestep due to large mesh dimesions and small diffusivity
numTimeSteps = 100 #approximately steady state
...
soptions.setVar('initialMassFraction0',0.25)
soptions.setVar('initialMassFraction1',0.75)
