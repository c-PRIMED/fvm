...
#ifndef _BATTERYLINEARIZEPOTENTIALINTERFACE_H_
#define _BATTERYLINEARIZEPOTENTIALINTERFACE_H_ 
...
template<class X, class Diag, class OffDiag>
  class BatteryLinearizePotentialInterface
{
 public:
 ...
 BatteryLinearizePotentialInterface(const GeomFields& geomFields,
			     Field& varField,
		  ...
		  MultiField& xField, MultiField& rField)
  {
	...
	const T_Scalar Temp = eTempCell[c0]; //  K , c0 and c1 temps are equal at convergence
	...
	T_Scalar eta_star = Phis_star-Phie_star-U;
