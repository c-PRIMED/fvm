...
#set transmissivities
popts["transmissivity1to0"]=1.0
popts["transmissivity0to1"]=1.0
...
"""
rightbc=bcMap[6]
rightbc.bcType="reflecting"
rightbc["specifiedTemperature"]=T_2
rightbc["specifiedReflection"]=1.
leftbc=bcMap[9]
leftbc.bcType="reflecting"
leftbc["specifiedTemperature"]=T_2
leftbc["specifiedReflection"]=1.
topbc1=bcMap[8]
topbc1.bcType="temperature"
topbc1["specifiedTemperature"]=T_2

topbc2=bcMap[5]
topbc2.bcType="temperature"
topbc2["specifiedTemperature"]=T_2

botbc1=bcMap[10]
botbc1.bcType="temperature"
botbc1["specifiedTemperature"]=T_1

botbc2=bcMap[7]
botbc2.bcType="temperature"
...
L=6 # arbitrary length
L_side = 3 # arbitrary length
ac_th=L/(vg*tau)
Kn=vg*tau/L
