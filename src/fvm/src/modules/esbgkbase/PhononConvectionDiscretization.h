#ifndef _PHONONCONVECTIONDISCRETIZATION_H_
#define _PHONONCONVECTIONDISCRETIZATION_H_
...
class PhononConvectionDiscretization : public Discretization
{
public:
 ...
 PhononConvectionDiscretization(const MeshList& meshes,
                  ...
                  MultiField& xField, MultiField& rField)
  {
	...
	for(int f=0; f<nFaces; f++)
	{
	    ...
	    const T_Scalar faceCFlux = faceArea[f][0]*_groupvel[0]
	      +faceArea[f][1]*_groupvel[1]+faceArea[f][2]*_groupvel[2] - gridFlux[f];
	...
	for(int f=0; f<nFaces; f++)
          {
              ...
              const int c1 = faceCells(f,1);
              const T_Scalar faceCFlux = faceArea[f][0]*_groupvel[0]
		+faceArea[f][1]*_groupvel[1]+faceArea[f][2]*_groupvel[2];
